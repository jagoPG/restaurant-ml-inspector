...
class EditFacebookSourceCommand(object):
    """
    Modifies a restaurant source from Facebook
    """
...
class EditFacebookSource(CommandHandler):
    def __init__(self):
    ...
    def invoke(self, command):
        ...
        restaurant = self.__retrieve_restaurant(project, facebook)
