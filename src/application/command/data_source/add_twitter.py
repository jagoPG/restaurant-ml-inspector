...
class AddTwitterSourceCommand(object):
    """
    Adds a new restaurant source from Twitter
    """
...
class AddTwitterSource(CommandHandler):
    def __init__(self):
    ...
    def invoke(self, command):
        ...
        self.__check_restaurant_not_exists(project, twitter)
        self.__create_restaurant_instance(command, project, twitter)
    ...
    def __create_restaurant_instance(self, command, project, social_network):
        restaurant = SocialNetworkRestaurant(
            social_network_identifier=command.name,
            geo_position=command.geo_position,
            project=project,
