...
class SetReviewSentimentTestCase(AppTestCase):
    CORRECT_ARGS = {
        'sentiment': 1
    }
    ...
    def test_is_xhr(self):
        ...
        response = self.client.put(
            '/admin/project/%s/review/%s/sentiment/' % (
                'f886388e-8f38-4463-8e72-f725c3218379',
                '230390187297922_1713062622337830'
             ),
            data=dumps(SetReviewSentimentTestCase.CORRECT_ARGS)
        )
    ...
    def test_user_has_permission(self):
        ...
        response = self.do_xhr_put(
            ...
            args=SetReviewSentimentTestCase.CORRECT_ARGS
        )
